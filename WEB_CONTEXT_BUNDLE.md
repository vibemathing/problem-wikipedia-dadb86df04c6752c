...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-dadb86df04c6752c"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-dadb86df04c6752c",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-dadb86df04c6752c",
        "url": "https://en.wikipedia.org/wiki/Orchard-planting_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Orchard-planting problem on the maximum number of 3-point lines attainable by a configuration of n points in the plane",
      "version": 1
    },
    "title": "Orchard-planting problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "0504abf79d690ab3645172642cdb03ff7cbe4696cd1d964d8d5b61ea769a630a"
}
```
